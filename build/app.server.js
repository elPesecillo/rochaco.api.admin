/******/ (function (modules) {
  ...
  /******/ /******/ return __webpack_require__(
    (__webpack_require__.s = "./src/server.js")
  );
  /******/
})(
  /************************************************************************/
  ...
  \********************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const connectDb = __webpack_require__(
          /*! ./models */ "./src/models/index.js"
        ).connectDb;

        var router = __webpack_require__(
          /*! ./routes/router */ "./src/routes/router.js"
        );
  ...
  \**************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        const userType = __webpack_require__(
          /*! ./types */ "./src/constants/types.js"
        ).userTypes;
        /**
         * Get menus list
         */
      ...
      /***/ function (module, exports) {
        ...
        exports.suburbStatus = [
          ...
          },
          {
            status: "feedback",
            description:
              "Tu solicitud a sido revisada, se requiere mas información.",
          },
        ];
  ...
  \***************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        const userServices = __webpack_require__(
          /*! ../logic/userService */ "./src/logic/userService.js"
        );

        const suburbService = __webpack_require__(
          /*! ../logic/suburbService */ "./src/logic/suburbService.js"
        ); //const fetchDbx = require('isomorphic-fetch');

        const fs = __webpack_require__(/*! fs */ "fs"); // const Dropbox = require("dropbox").Dropbox;

        const dropboxV2Api = __webpack_require__(
          /*! dropbox-v2-api */ "dropbox-v2-api"
        );

        const sgMail = __webpack_require__(
        ...
        const processFileUpload = async (files, data) => {
          try {
            ...
            let validCaptcha = await userServices.validateRecaptcha(
              recaptchaToken
            );
            let proms = [];
            files.forEach((file) => {
  ...
  \**********************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        const menuService = __webpack_require__(
          /*! ../logic/menuService */ "./src/logic/menuService.js"
        );
        /**
  ...
  \****************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        const postalCodeService = __webpack_require__(
          /*! ../logic/postalCodeService */ "./src/logic/postalCodeService.js"
        );

        exports.getPostalCodeInfo = async (req, res, next) => {
          try {
            let result = await postalCodeService.getCPInfo(
  ...
  \*********************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        const pushNotificationService = __webpack_require__(
          /*! ../logic/pushNotificationService */ "./src/logic/pushNotificationService.js"
        );

        const { getUserById } = __webpack_require__(
          /*! ../logic/userService */ "./src/logic/userService.js"
        );
  ...
  \***********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        const user = __webpack_require__(
          /*! ./userAdmin */ "./src/controllers/userAdmin.js"
        );
        ...
        exports.signUp = (req, res, next) => {
          if (
            ...
            res.send({
              success: false,
              message:
                "Por favor intenta de nuevo (codigo recaptcha no encontrado).",
            });
            return;
          }
  ...
  \*************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const viewPermissions = __webpack_require__(
          /*! ../logic/viewPermissions */ "./src/logic/viewPermissions.js"
        );

        const axios = __webpack_require__(/*! axios */ "axios").default;

        const validateRecaptcha = __webpack_require__(
          /*! ../logic/auth */ "./src/logic/auth.js"
        ).validateRecaptcha;
        ...
        exports.generateTempPassword = async (req, res) => {
          try {
            let { email, captchaToken } = req.query;
            let validCaptcha = await validateRecaptcha(captchaToken);
        ...
        exports.validateTokenPath = (req, res, next) => {
          let { token, user, path } = req.body; //over here add logic to check if a path is valid for the given context (user-> userType and jwt token)
            ...
            req.session.destroy((err) => {
              if (err)
                res.status("500").json({
                  ...
                  message:
                    err.message ||
                    "An unknow error occurs while trying to log off.",
                });
              res.status("200").json({
                success: true,
  ...
  \***********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const userService = __webpack_require__(
          /*! ../logic/userService */ "./src/logic/userService.js"
        );

        const userTypes = __webpack_require__(
          /*! ../constants/types */ "./src/constants/types.js"
        ).userTypes;

        const moment = __webpack_require__(/*! moment */ "moment");

        const ObjectId = __webpack_require__(/*! mongoose */ "mongoose").Types
          .ObjectId;
        ...
        exports.approveReject = async (req, res, next) => {
          try {
            ...
            res.status(400).json({
              ...
              message:
                ex.message ||
                "No se pudo procesar aprobar/rechazar la colonia.",
            });
          }
        };
          ...
          suburbService.getSuburbByAdminUser(userId).then(
            ...
            (err) => {
              res.status(400).json({
                ...
                message:
                  err.message ||
                  "No se pudo obtener la informacion de la colonia.",
              });
            }
          );
        };
            ...
            .then(
              ...
              (err) => {
                res.status(500).json({
                  ...
                  message:
                    err.message ||
                    "No se pudo generar la invitacion para el usuario.",
                });
              }
            );
        };
            ...
            userService.getUsersBySuburbStreet(suburbId, street).then(
              ...
              (err) => {
                res.status(500).json({
                  ...
                  message:
                    err.message ||
                    "No se pudieron obtener los numeros de la calle",
                });
              }
            );
          } else
            ...
            suburbService
              ...
              .catch((err) => {
                res.status(500).json({
                  success: false,
                  message:
                    err.message || "No se pudo actualizar la configuracion",
                });
              });
          } else
            res.status(400).json({
  ...
  \**************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const SuburbInvite = __webpack_require__(
          /*! ../models/suburbInvite */ "./src/models/suburbInvite.js"
        );
                ...
                .then(
                  (resSave) => {
                    res.status("200").json({
                      success: true,
                      message:
                        res.message || "Has sido registrado correctamente.",
                    });
                  },
                  (err) => {
                    res.status("400").json({
          ...
          try {
            ...
            if (validCaptcha) {
              ...
              res.status("200").json({
                success: true,
                message:
                  updateCode.message || "Has sido registrado correctamente.",
              });
            } else
              res.status("401").json({
                success: false,
        ...
        exports.addUserPushToken = async (req, res, next) => {
          try {
            ...
            let pushTokens = await userService.addUserPushToken(
              userId,
              pushToken
            );
  ...
  \**********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const menus = __webpack_require__(
          /*! ../constants/menusConfig */ "./src/constants/menusConfig.js"
        ).menus;
        /**
          ...
          return new Promise((resolve, reject) => {
            ...
            getPayload.then(
              (payload) => {
                ...
                let userMenus = menus
                  .filter((menu) => {
                    let types = menu.validUserTypes.filter(
  ...
  \****************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        const PostalCode = __webpack_require__(
          /*! ../models/postalCode */ "./src/models/postalCode.js"
        );
              ...
              getInfo.then(
                ...
                (err) => {
                  reject({
                    valid: false,
                    message:
                      "No se pudo obtener la informaion del codigo postal.",
                  });
                }
              );
            } else {
  ...
  \**********************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        const Expo = __webpack_require__(
  ...
  \************************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        const Suburb = __webpack_require__(
          /*! ../models/suburb */ "./src/models/suburb.js"
        );

        const suburbStatus = __webpack_require__(
          /*! ../constants/types */ "./src/constants/types.js"
        ).suburbStatus;
        ...
        const SuburbConfig = __webpack_require__(
          /*! ../models/suburbConfig */ "./src/models/suburbConfig.js"
        );

        const SuburbStreet = __webpack_require__(
          /*! ../models/suburbStreet */ "./src/models/suburbStreet.js"
        );
            ...
            Suburb.SaveSuburb(suburbObj).then((sub, err) => {
              if (!err)
                ...
                reject({
                  ...
                  message:
                    err.message ||
                    "Ocurrio un error al intentar guardar la colonia.",
                });
            });
          });
        };
            ...
            Suburb.UpdateStatus(id, status).then((sub, err) => {
              if (!err)
                resolve({
                  success: true,
                  message:
                    "El status de la colonia fue actualizado correctamente.",
                });
              else
                reject({
                  success: false,
        ...
        const suburbAddStatusByName = (name, postalCode, status) => {
          return new Promise((resolve, reject) => {
            Suburb.UpdateStatusByName(name, postalCode, status).then(
              (sub, err) => {
                if (!err)
                  resolve({
                    success: true,
              ...
              .then((sub, err) => {
                if (!err) resolve(sub);
                  ...
                  reject({
                    ...
                    message:
                      err.message ||
                      "Ocurrio un error al intentar obtener la colonia.",
                  });
              })
              .catch((err) => reject(err));
          });
          ...
          try {
            ...
            let selectedStreet = suburbData.streets
              ? suburbData.streets.filter(
                  (st) =>
                    st.street.toLowerCase() === street.street.toLowerCase()
                )
              : [];
  ...
  \**********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const GlobalConfig = __webpack_require__(
          /*! ../models/globalConfig */ "./src/models/globalConfig.js"
        );
            ...
            User.getLogin(userObj.loginName).then(
              (login) => {
                if (login) {
                  reject({
                    success: false,
                    message:
                      "El usuario existe actualmente en la base de datos.",
                  });
                } else {
                  //create the user
                  User.saveUser(
              ...
              (err) => {
                reject({
                  ...
                  message:
                    err.message ||
                    "Ocurrio un error al tratar de guardar el usuario.",
                });
              }
            );
          });
        ...
        const getUsersByAddress = async (suburbId, street, streetNumber) => {
          try {
            let users = await User.getUsersByAddress(
              suburbId,
              street,
              streetNumber
            );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const validateWithPayload = (path, payload) => {
          ...
          let validPath = permissions.filter((p) => {
            let types = p.validUserTypes.filter(
              (g) => g.toLowerCase() === userType.toLowerCase()
            );
            return (
              types.length > 0 &&
              p.path.toLowerCase() === path.toLocaleLowerCase()
            );
          });
  ...
  \********************************/
      /*! no static exports found */
      /***/ function (module, exports, __webpack_require__) {
        const Auth = __webpack_require__(
          /*! ../logic/auth */ "./src/logic/auth.js"
        ).Auth;
          ...
          validApiRequest(apiPath, token).then(
            ...
            (err) =>
              res.status("401").json({
                ...
                error:
                  err.message ||
                  "An error occurs while validating the request.",
              })
          );
        };
  ...
  \*****************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const SuburbInvite = __webpack_require__(
          /*! ./suburbInvite */ "./src/models/suburbInvite.js"
        );

        const SuburbConfig = __webpack_require__(
          /*! ./suburbConfig */ "./src/models/suburbConfig.js"
        );

        const SuburbStreet = __webpack_require__(
          /*! ./suburbStreet */ "./src/models/suburbStreet.js"
        );

        const PostalCode = __webpack_require__(
          /*! ./postalCode */ "./src/models/postalCode.js"
        );

        const GlobalConfig = __webpack_require__(
          /*! ./globalConfig */ "./src/models/globalConfig.js"
        );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        MenuSchema.statics = {
          ...
          getChildMenusRecursively: function (parents) {
            ...
            let elements = [];
            return new Promise((resolve, reject) => {
              getThisLevelChilds.then(
                (childs) => {
                  if (childs.length > 0) {
                    elements = JSON.parse(JSON.stringify(childs)).map(
                      (child) => {
                        return child._id;
                      }
                    );

                    let getInnerChilds = _this.getChildMenusRecursively(
                      elements
                    );
              ...
              getThisLevel.then(
                (menu) => {
                  ...
                  if (menu && menu.parentId) {
                    ...
                    let getMoreParents = _this.getParentMenusRecursively(
                      menu.parentId
                    );
  ...
  \**************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const DropdownSchema = __webpack_require__(
          /*! ./dropdownSchema */ "./src/models/schemas/config/dropdownSchema.js"
        );
  ...
  \***************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const FieldSchema = __webpack_require__(
          /*! ./fieldSchema */ "./src/models/schemas/config/fieldSchema.js"
        );
  ...
  \******************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const SuburbStatusSchema = __webpack_require__(
          /*! ./schemas/suburbStatusSchema */ "./src/models/schemas/suburbStatusSchema.js"
        );

        const SuburbFileSchema = __webpack_require__(
          /*! ./schemas/suburbFileSchema */ "./src/models/schemas/suburbFileSchema.js"
        );
  ...
  \************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const ScreenSchema = __webpack_require__(
          /*! ./schemas/config/screenSchema */ "./src/models/schemas/config/screenSchema.js"
        );
  ...
  \************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const { getUsersBySuburbStreet } = __webpack_require__(
          /*! ../logic/userService */ "./src/logic/userService.js"
        );
  ...
  \****************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const GuestSchema = __webpack_require__(
          /*! ./schemas/guestSchema */ "./src/models/schemas/guestSchema.js"
        );

        const PushTokenSchema = __webpack_require__(
          /*! ./schemas/pushTokenSchema */ "./src/models/schemas/pushTokenSchema.js"
        );
        ...
        UserSchema.methods = {
                      ...
                      this.increaseLoginAttempts().then(
                        ...
                        (err) =>
                          reject({
                            success: false,
                            message:
                              "Un error occurio, la contraseña no es valida.",
                          })
                      );
                    }
                  });
          ...
          getDisabledSince: function () {
            let disabledSince = this.disabledSince
              ? this.disabledSince
              : moment.utc();
          ...
          generateUserToken: function (_suburb) {
            let payload = {
              userId:
                this._id != undefined
                  ? JSON.parse(JSON.stringify(this._id))
                  : "",
          ...
          addUserFavs: function (userId, favs) {
            return new Promise((resolve, reject) => {
              this.findOne({
                ...
                let mergedFavs = mergeArrayObjects(
                  result.favorites || [],
                  favs
                );
                this.findOneAndUpdate(
            ...
            return new Promise((resolve, reject) => {
              this.findOne({
                ...
                let filterFavs = (result.favorites || []).filter((item) => {
                  let exists = favs.filter(
                    (f) => f.name.trim() === item.name.trim()
                  );
  ...
  \*********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const siteAuth = __webpack_require__(
          /*! ../controllers/siteAuth */ "./src/controllers/siteAuth.js"
        );

        const menus = __webpack_require__(
          /*! ../controllers/menus */ "./src/controllers/menus.js"
        );

        const postalCodes = __webpack_require__(
          /*! ../controllers/postalCodes */ "./src/controllers/postalCodes.js"
        );

        const signup = __webpack_require__(
          /*! ../controllers/signup */ "./src/controllers/signup.js"
        );

        const handleFiles = __webpack_require__(
          /*! ../controllers/handleFile */ "./src/controllers/handleFile.js"
        );

        const multer = __webpack_require__(/*! multer */ "multer");

        const suburb = __webpack_require__(
          /*! ../controllers/suburb */ "./src/controllers/suburb.js"
        );

        const pushNotification = __webpack_require__(
          /*! ../controllers/pushNotification */ "./src/controllers/pushNotification.js"
        );
        ...
        const userAdmin = __webpack_require__(
          /*! ../controllers/userAdmin */ "./src/controllers/userAdmin.js"
        );
        ...
        router.post(
          "/api/userInfo/addUserPushToken",
          userAdmin.addUserPushToken
        );
        router.get(
          "/api/userInfo/getUsersByAddress",
          userAdmin.getUsersByAddress
        );
        router.post("/api/userInfo/updatePicture", userAdmin.updateUserPicture);
        router.get(
          "/api/userInfo/getSignedUserTerms",
          userAdmin.getSignedUserTerms
        );
  ...
  \******************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const apiRoutes = __webpack_require__(
          /*! ./apiRoutes */ "./src/routes/apiRoutes.js"
        );
